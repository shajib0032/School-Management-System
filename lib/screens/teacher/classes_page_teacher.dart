...
import '../../screens/teacher/task_page.dart';
import '../../widgets/teacher/group_tile_teacher.dart';
...
class _TeacherClassesState extends State<TeacherClasses> {
  ...
  @override
  void initState() {
    groups = GetHelper.getData("$widget.teacherId.toString()", 'get_teacher_groups',
  ...
  goTaskForm(String groupId, String schoolId) {
    Navigator.push(
      context,
      MaterialPageRoute( builder: (context) => TaskPage(groupId: groupId, schoolId: schoolId,)),
    );
  }
              ...
              child: Container(
                  ...
                  child: FutureBuilder <List>(
                    ...
                    builder: (context, snapshots) {
                      if (!snapshots.hasData || snapshots.data.toString().length == 0) {
                        return Center(
